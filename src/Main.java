            ...
            switch (choice) {
                ...
                case 4 -> {
                    ...
                    if (taskType == TaskType.TASK) {
                        ...
                        if (!tm.taskList.containsKey(taskId)) {
                        ...
                        if (!tm.subTaskList.containsKey(subTaskId)) {
